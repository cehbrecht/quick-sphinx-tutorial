# -*- coding: utf-8 -*-
#
# Giza documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Giza.tex', u'Giza Documentation',
...
man_pages = [
    (master_doc, 'giza', u'Giza Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Giza', u'Giza Documentation',
     author, 'Giza', 'One line description of project.',
     'Miscellaneous'),
]
